...
var Model = (function () {
  function Model() {}
  Model.serviceName = "trainingV2.Model";
  return Model;
}());
...
Model.create_model = {
  ...
  requestType: training_v2_pb.NewModel,
  responseType: training_v2_pb.ModelID
};
...
Model.validate_model_price = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: training_v2_pb.ValidateRequest,
...
Model.upload_and_validate = {
  ...
  requestStream: true,
  responseStream: false,
  requestType: training_v2_pb.UploadInput,
...
Model.train_model_price = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: training_v2_pb.ModelID,
  responseType: training_v2_pb.PriceInBaseUnit
};
